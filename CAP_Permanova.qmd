...
library(ordr)
ggplot() + 
  geom_point(data = Zrfit_points,  #this adds the points
             aes(x = x, y = y, color = habitat)) + 
  geom_vector(data = Zrfit_arrows, aes(x = x, y = y)) + #this adds the lines
  geom_text(data = Zrfit_arrows,  #this adds the text
